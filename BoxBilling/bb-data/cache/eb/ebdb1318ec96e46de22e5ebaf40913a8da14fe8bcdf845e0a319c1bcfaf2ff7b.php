...
class __TwigTemplate_e0aaa51dc2a635a5c6cc9ecccbb9c1781e1583fa855fa52cc483e909ed8b8bbf extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% if guest.extension_is_on({\"mod\":\"spamchecker\"}) %}
    ...
    {% endif %}
{% endmacro %}
", "macro_functions.phtml", "/var/www/localhost/htdocs/bb-themes/boxbilling/html/macro_functions.phtml");
    }
}
